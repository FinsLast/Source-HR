...
import { DataService, apiResultFormat, getShiftSchedule } from 'src/app/core/core.index';
...
export class ShiftScheduleComponent implements OnInit {
  ...
  private getTableData(): void {
    ...
    this.data.getShiftSchedule().subscribe((res: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource<getShiftSchedule>(this.lstArchivedjobs);
